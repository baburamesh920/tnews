...
if(isset($_POST['update']))
{
    ...
    if($images_name == ''){
	    $sql=mysqli_query($con,"UPDATE `breaking_news` SET `breaking_news`='$category',`category_type`='$category_type',`reporter_name`='$r_name',`content`='$content',`news_length`='$nl',`type`='$type',`location`='$location',`language`='$language',`reporter`='$r' WHERE  id='$id'");
	}
	else if($images_name != ''){
	    $sql=mysqli_query($con,"UPDATE `breaking_news` SET `breaking_news`='$category',`category_type`='$category_type',`reporter_name`='$r_name',`content`='$content',`news_length`='$nl',`type`='$type',`image`='$images_name',`location`='$location',`language`='$language',`reporter`='$r' WHERE  id='$id'");
	}
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-3 control-label" for="name">Breaking News</label>
			   <div class="col-md-9">
                <input type="text" name="breaking_news" class="form-control" value="<?php echo $row['breaking_news']; ?>" required="required" />
