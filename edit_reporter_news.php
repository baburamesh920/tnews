...
if(isset($_POST['update']))
{
   ...
   // if(isset($_POST['content'])){
	...
	$reporter_name=$_POST['reporter_name'];
     if($images_name == ''){
		$sql=mysqli_query($con,"UPDATE `news` SET `title`='$title',`reporter_name`='$reporter_name',`category_type`='$category_type',`content`='$content',`news_length`='$nl',`type`='$type',`video_link`='$video_name',`question`='$ques',`opt_a`='$a',`opt_b`='$b',`opt_c`='$c',`opt_d`='$d',`youtube_link`='$yl',`location`='$location',`language`='$language',`reporter`='$r' WHERE  id='$id'");
	}
	 else if($images_name != ''){
	    $sql=mysqli_query($con,"UPDATE `news` SET `title`='$title',`reporter_name`='$reporter_name',`category_type`='$category_type',`content`='$content',`news_length`='$nl',`type`='$type',`image`='$images_name',`video_link`='$video_name',`question`='$ques',`opt_a`='$a',`opt_b`='$b',`opt_c`='$c',`opt_d`='$d',`youtube_link`='$yl',`location`='$location',`language`='$language',`reporter`='$r' WHERE  id='$id'");
	}
	else{
   $sql=mysqli_query($con,"UPDATE `news` SET `title`='$title',`reporter_name`='$reporter_name',`category_type`='$category_type',`content`='$content',`news_length`='$nl',`type`='$type',`image`='$images_name',`video_link`='$video_name',`question`='$ques',`opt_a`='$a',`opt_b`='$b',`opt_c`='$c',`opt_d`='$d',`youtube_link`='$yl',`location`='$location',`language`='$language',`reporter`='$r' WHERE  id='$id'");
	  }
...
//var_dump($result);die;
        ...
        while($row=mysqli_fetch_assoc($not_query))
    {
      ...
      header("location:reporter_news.php");
		...
		echo "<script>alert('Min. 160 characters.');</script>";
}
}
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
         ...
         <label class="col-md-3 control-label" for="title">Title</label>
              <div class="col-md-9">
              <input id="title" name="title" class="form-control" placeholder="Enter Title" value="<?php echo $row['title']?>" required />
			 ...
			 <div class="form-group">
              ...
              <div class="col-md-9">
              <input name="reporter_name" class="form-control" placeholder="Enter Your Name" value="<?php echo $row['reporter_name']?>"/>
		...
		//  Image And Content News  
			 ...
			 <div id="cnt">
				<div class="form-group">
					  ...
					  <p style='color:red;display:none;' id="msg2"><b>Note:</b> Min. 160 characters.</p>
