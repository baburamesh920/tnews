 ...
 <div id="page-wrapper">
	...
	$i=1;
	 $sql=mysqli_query($con,"SELECT breaking_news.language,breaking_news.breaking_news,breaking_news.id,breaking_news.breaking_news,category_type.category_type as category_type,breaking_news.content,breaking_news.type,breaking_news.image,breaking_news.location,breaking_news.reporter_name,breaking_news.user_name
    FROM breaking_news 
    ...
    while($row=mysqli_fetch_assoc($sql))
    {
        ?>
            <tr>
                ...
                <!-- <td class="text-center"><a class='btn btn-info btn-xs' href="edit_breaking_news.php?id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-edit"></span> Edit</a></td> -->
   <td class="text-center"><a class='btn btn-info btn-xs' href="edit_reporter_breaking_news.php?id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
                 <td class="text-center"><a class='btn btn-info btn-xs' href="reporter_delete_breaking_news.php?id=<?php echo $row['id'];?>" ><span class="glyphicon glyphicon-trash"></span> delete</a> <!-- <a href="#" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Del</a></td> -->
            </tr>
         <?php
         $i++;
     }
