 ...
 <div id="page-wrapper">
    ...
    $i=1;
    $sql=mysqli_query($con,"SELECT news.id,news.title,category_type.category_type as category_type,news.content,news.type,news.image,news.video_link,news_location.location,news.user_name
    FROM news 
    ...
    while($row=mysqli_fetch_assoc($sql))
    {
        ?>
            <tr>
				...
				<td class="text-center"><a class='btn btn-info btn-xs' href="post_news.php?id=<?php echo $row['id'];?>"></span> post</a></td>
            </tr>
    <?php
         $i++;
     }
